...
EtabRgp = [
    ...
    {NomEtabRgp: "CFA MFR Centre et Île-de-France",
     UaiRgp: ["0451715v", "0370983t", "0371686g", "0371710h", "0371711j", "0371723x", "0411059d", "0451691u",
              "0451693w", "0451694x"]}
];
...
if __name__ == "__main__":
    ...
    miseAJour(host, user, password, nomBD, port, ldapServer, ldapUsername, ldapPassword, listeEtab, listeEtabSansAdmin,
              ...
              NomEtabRgp, UaiRgp, fileTrtPrecedent, fileSeparator, purge)

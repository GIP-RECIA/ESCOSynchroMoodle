...
ATTRIBUTES_STRUCTURE = [ 'ou','ENTStructureSIREN','ENTStructureTypeStruct','postalCode', 'ENTStructureUAI', 'ESCODomaines','+' ]

# Attributs retournes pour une personne
ATTRIBUTES_PEOPLE = [ 'objectClass', 'uid','sn','givenName','mail','ESCODomaines', 'ESCOUAICourant', 'ENTPersonStructRattach', 'isMemberOf', '+' ]

# Attributs retournes pour un eleve
ATTRIBUTES_STUDENT = [ 'uid','sn','givenName','mail','ENTEleveClasses','ENTEleveNivFormation','ESCODomaines','ESCOUAICourant','+' ]

# Attributs retournes pour un enseignant
ATTRIBUTES_TEACHER = [ 'objectClass', 'uid','sn','givenName','mail','ESCOUAI','ESCODomaines', 'ESCOUAICourant', 'ENTPersonStructRattach', 'ENTPersonProfils', 'isMemberOf','+' ]

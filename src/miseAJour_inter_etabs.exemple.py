...
# TOUS
############
inter_etabs_cohorts_all = dict(
    inter_etabs_cohorts_cfa.items() + inter_etabs_cohorts_lycees.items() + inter_etabs_cohorts_lycees_agri.items() + inter_etabs_cohorts_colleges.items())
...
if __name__ == "__main__":
    ...
    miseAJourInterEtabsAll(host, user, password, nomBD, port, ldapServer, ldapUsername, ldapPassword, structuresDN,
                           personnesDN, entete, interEtabsAttribut, interEtabsUser, interEtabsAdmin,
                           inter_etabs_cohorts_all, fileTrtPrecedentInterEtabs, fileSeparatorInterEtabs, purge)

    # Mise a jour pour la categorie inter-etablissements avec uniquement les CFA :
    #  - des utilisateurs
    #  - des administrateurs locaux
    miseAJourInterEtabsCFA(host, user, password, nomBD, port, ldapServer, ldapUsername, ldapPassword, structuresDN,
                           personnesDN, entete, interEtabsAttribut, interEtabsUser, interEtabsAdmin,
                           inter_etabs_cohorts_cfa, fileTrtPrecedentInterEtabsCFA, fileSeparatorInterEtabsCFA, purge)

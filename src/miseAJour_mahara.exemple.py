...
maharaUser = ["clg37:Etablissements:*:groupes_locaux:Mahara:Moodle-Mahara",
              "esco:Etablissements:*:groupes_locaux:Mahara:Moodle-Mahara"]
...
if __name__ == "__main__":
    ...
    miseAJourMahara(host, user, password, nomBD, port, ldapServer, ldapUsername, ldapPassword, personnesDN, entete,

...
#######################################
miseAJourInspecteurs( host, user, password, nomBD, port, ldapServer, ldapUsername, ldapPassword, personnesDN, structuresDN, entete, attributInspecteur, valeurAttributInspecteur )
